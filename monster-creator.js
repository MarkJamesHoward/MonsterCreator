...
//@ts-ignore
let MonsterCreator = class MonsterCreator extends GestureEventListeners(LitElement) {
    constructor() {
        super();
    ...
    <div class="CharacterCustomizeMain">
      ...
      <div id="eyesandsilcontainer" style="position:relative">  
        ...
        <div class="eyes">
          <div class="${this.customize != "Yes" && this.EyesSlot1Used == false
            ? "DisableCustomize"
            : ""}">
            <div id="EyesSlot1" class="${this.EyesSlot1Used ? "EyesSlot1" : "Eye1ResetPostion"}">
              <slot name="EyesSlot1" ></slot>
            </div>
          </div>

          <div class="${this.customize != "Yes" && this.EyesSlot2Used == false
            ? "DisableCustomize"
            : ""}">
            <div id="EyesSlot2" class="${this.EyesSlot2Used ? "EyesSlot2" : "Eye2ResetPostion"}">
              <slot name="EyesSlot2" ></slot>
            </div>
          </div>

          <div class="${this.customize != "Yes" && this.EyesSlot3Used == false
            ? "DisableCustomize"
            : ""}">
            <div id="EyesSlot3" class="${this.EyesSlot3Used ? "EyesSlot3" : "Eye3ResetPostion"}">
              <slot name="EyesSlot3" ></slot>
            </div>
          </div>

          <div class="${this.customize != "Yes" && this.EyesSlot4Used == false
            ? "DisableCustomize"
            : ""}">
            <div class="${this.level > 3 ? "" : "hidden"}">
              <div id="EyesSlot4" class="${this.EyesSlot4Used ? "EyesSlot4" : "Eye4ResetPostion"}">
        ...
        <div class='mouth'>
          ...
          <div class="${this.customize != "Yes" && this.MouthSlot1Used == false
            ? "DisableCustomize"
            : ""}">
              <div class="${this.level > 0 ? "" : "hidden"}">
                <div id="MouthSlot1" class="${this.MouthSlot1Used ? "MouthSlot1" : "Mouth1ResetPostion"}">
                  <slot name="MouthSlot1" ></slot>        
                </div>
              </div>
          </div>

          <div class="${this.customize != "Yes" && this.MouthSlot2Used == false
            ? "DisableCustomize"
            : ""}">
              <div class="${this.level > 1 ? "" : "hidden"}">
                <div id="MouthSlot2" class="${this.MouthSlot2Used ? "MouthSlot2" : "Mouth2ResetPostion"}">
                  <slot name="MouthSlot2" ></slot>        
                </div>
              </div>
          </div>

          <div class="${this.customize != "Yes" && this.MouthSlot3Used == false
            ? "DisableCustomize"
            : ""}">
              <div class="${this.level > 2 ? "" : "hidden"}">
                <div id="MouthSlot3" class="${this.MouthSlot3Used ? "MouthSlot3" : "Mouth3ResetPostion"}">
                  <slot name="MouthSlot3" ></slot>        
                </div>
              </div>
          </div>
              
          <div class="${this.customize != "Yes" && this.MouthSlot4Used == false
            ? "DisableCustomize"
            : ""}">
              <div class="${this.level > 3 ? "" : "hidden"}">
                <div id="MouthSlot4" class="${this.MouthSlot4Used ? "MouthSlot4" : "Mouth4ResetPostion"}">
      ...
      <div class="OverlayTwoItemsCharacter">
        <div style="grid-area:main; margin: 0 auto" class="${this.selectedsilhouetteindex == 1 ? "" : "hidden"}">
          <slot style="margin: 0 auto"  name="pickedsilhouette1"></slot>
        </div>
        <div style="grid-area:main;  margin: 0 auto" class="${this.selectedsilhouetteindex == 2 ? "" : "hidden"}">
          <slot style="margin: 0 auto"  name="pickedsilhouette2"></slot>
        </div>
        <div style="grid-area:main;  margin: 0 auto" class="${this.selectedsilhouetteindex == 3 ? "" : "hidden"}">
          <slot style="margin: 0 auto"  name="pickedsilhouette3"></slot>
        </div>
        <div  style="grid-area:main;  margin: 0 auto" class="${this.selectedsilhouetteindex == 4 ? "" : "hidden"}">
          <slot style="margin: 0 auto"  name="pickedsilhouette4"></slot>
        </div>
        <div style="grid-area:main;  margin: 0 auto" class="${this.selectedsilhouetteindex == 5 ? "" : "hidden"}">
      ...
      <div id='SilhouetteSelector' class="${this.customize == "Yes" ? "silhouette" : "DisableCustomize"}">
      
        <div @click="${() => this.Pick(1)}" class="OverlayTwoItemsCharacter silhouettePicker">
          ...
          <div @click="${() => this.Pick(2)}" class="OverlayTwoItemsCharacter silhouettePicker">
          <iron-icon class="${this.level >= 2 ? "NoPadlock" : ""}" style="grid-area:main;z-index:2;align-self:center;justify-self:center" icon="lock"></iron-icon>
          <slot name="silhouette2"><div class="MissingImage">Please supply Silhouette2.png</div></slot>
        </div>
        
        <div @click="${() => this.Pick(3)}" class="OverlayTwoItemsCharacter silhouettePicker">
        ...
        <div @click="${() => this.Pick(4)}" class="OverlayTwoItemsCharacter silhouettePicker">
        ...
        <div @click="${() => this.Pick(5)}" class="OverlayTwoItemsCharacter silhouettePicker">
          <slot name="silhouette5"><div class="MissingImage">Please supply Silhouette5.png</div></slot>
          <iron-icon class="${this.level >= 5 ? "NoPadlock" : ""}" style="grid-area:main;z-index:2;align-self:center;justify-self:center"
            icon="lock"></iron-icon>
        </div>
      </div>
...
], MonsterCreator.prototype, "selectedeyex", void 0);
__decorate([
    property({ type: Number, reflect: true, attribute: true })
], MonsterCreator.prototype, "selectedeyey", void 0);
__decorate([
    property({ type: Number, reflect: true, attribute: true })
], MonsterCreator.prototype, "selectedmouthindex", void 0);
__decorate([
    property({ type: Number, reflect: true, attribute: true })
], MonsterCreator.prototype, "selectedmouthx", void 0);
__decorate([
    property({ type: Number, reflect: true, attribute: true })
], MonsterCreator.prototype, "selectedmouthy", void 0);
__decorate([
    property({ type: Number, reflect: true, attribute: true })
], MonsterCreator.prototype, "selectedsilhouetteindex", void 0);
__decorate([
    property({ type: Number })
], MonsterCreator.prototype, "NUMBER_OF_IMAGES_EYES", void 0);
__decorate([
    property({ type: Number })
], MonsterCreator.prototype, "NUMBER_OF_IMAGES_MOUTH", void 0);
__decorate([
    property({ type: Number })
], MonsterCreator.prototype, "NUMBER_OF_IMAGES_SILHOUETTES", void 0);
__decorate([
    property({ type: Number, attribute: true })
], MonsterCreator.prototype, "level", void 0);
__decorate([
    property({ type: String })
], MonsterCreator.prototype, "customize", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "EyesSlot1Used", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "EyesSlot2Used", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "EyesSlot3Used", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "EyesSlot4Used", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "MouthSlot2Used", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "MouthSlot3Used", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "MouthSlot4Used", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], MonsterCreator.prototype, "MouthSlot1Used", void 0);
__decorate([
    property({ type: Number, reflect: true, attribute: true })
], MonsterCreator.prototype, "selectedeyeindex", void 0);
MonsterCreator = __decorate([
